...
<div class="post-image-left">
    <a href="{{site.url}}/img/caesar-cipher.jpg" data-lightbox="rsa" data-title="Vòng mã hóa Caesar">
        <img src="{{site.url}}/img/caesar-cipher.jpg">
    </a>
...
<div class="post-image-left">
    <a href="{{site.url}}/img/public-key-cryptography.png" data-lightbox="rsa" data-title="Sơ đồ public-key cryptography <i>(Nguồn: <a href='https://en.wikipedia.org/wiki/Public-key_cryptography'>Wikipedia</a>)">
        <img src="{{site.url}}/img/public-key-cryptography.png" class="post-image">
    </a>
